...
//---------------------------------------------------------------------------
//以给定方式打开，并且没有后缀
TempFile::TempFile(const string& baseName,const std::_Ios_Openmode app) :
	baseName(baseName), fileName(baseName), out(fileName.c_str(), ios::out | ios::binary | app), writePointer(0)
// Constructor
{
}
//---------------------------------------------------------------------------
